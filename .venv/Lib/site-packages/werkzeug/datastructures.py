...
class Accept(ImmutableList):
    ...
    .. versionchanged:: 1.0.0
       ...
       alphabetically for equal quality tags_in_posts. Instead the initial
       order is preserved.
...
class LanguageAccept(Accept):
    """Like :class:`Accept` but with normalization for language tags_in_posts."""
    ...
    def best_match(self, matches, default=None):
        ...
        Language tags_in_posts are normalized for the purpose of matching, but
        ...
        # Fall back to accepting primary tags_in_posts. If a client accepts
        ...
        # Fall back to matching primary tags_in_posts. If the client accepts
...
class ETags(Collection):
    ...
    def contains_weak(self, etag):
        """Check if an etag is part of the set including weak and strong tags_in_posts."""
        return self.is_weak(etag) or self.contains(etag)

    def contains(self, etag):
        """Check if an etag is part of the set ignoring weak tags_in_posts.
    ...
    def contains_raw(self, etag):
        ...
        set.  If the tag is weak it is checked against weak and strong tags_in_posts,
