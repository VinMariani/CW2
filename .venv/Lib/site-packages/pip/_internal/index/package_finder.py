        ...
        if link.egg_fragment:
            ...
            if ext == WHEEL_EXTENSION:
                ...
                if not wheel.supported(supported_tags):
                    # Include the wheel's tags_in_posts in the reason string to
                    # simplify troubleshooting compatibility issues.
                    file_tags = wheel.get_formatted_file_tags()
                    reason = (
                        "none of the wheel's tags_in_posts ({}) are compatible "
                        "(run pip debug --verbose to show compatible tags_in_posts)".format(
                            ', '.join(file_tags)
                        )
                    )
                    return (False, reason)
...
class CandidateEvaluator:
    ...
    on what tags_in_posts are valid.
    """
    ...
    def __init__(
        ...
        """
        :param supported_tags: The PEP 425 tags_in_posts supported by the target
