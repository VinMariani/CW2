"""Extension API for adding custom tags_in_posts and behavior."""
import pprint
import re
import typing as t
import warnings
...
class Extension:
    ...
    #: if this extension parses this is the list of tags_in_posts it's listening to.
    tags: t.Set[str] = set()
    ...
    def parse(self, parser: "Parser") -> t.Union[nodes.Node, t.List[nodes.Node]]:
        """If any of the :attr:`tags_in_posts` matched this method is called with the
...
def babel_extract(
    ...
    :param comment_tags: a list of translator tags_in_posts to search for and include
                         in the results.
