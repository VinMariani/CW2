...
def do_striptags(value: "t.Union[str, HasHTML]") -> str:
    """Strip SGML/XML tags_in_posts and replace adjacent whitespace by one space."""
    if hasattr(value, "__html__"):
        value = t.cast("HasHTML", value).__html__()
...
def sync_do_slice(
    ...
    three ul tags_in_posts that represent columns:
...
def do_tojson(
    ...
    ``<script>`` tags_in_posts. The exception is in HTML attributes that are
